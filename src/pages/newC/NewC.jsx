...
const NewC = () => {
  ...
  const [Nombre_Cv, setNombre_Cv] = useState('')
  ...
  const hundleSubmit = async (e) => {
    e.preventDefault();
    try {
      const resp = await axios.post('http://127.0.0.1:8000/api/Voiture-create/', { Matricule: Matricule, Marque: Marque, Nombre_Cv: Nombre_Cv, Serie: Serie, Annee: Annee });
          ...
          <div className="right">
            <form onSubmit={hundleSubmit}>
              <div className="formInput">
                ...
                <input type="text" placeholder='1234' id='Matricule' value={Matricule} onChange={(e) => setMatricule(e.target.value)} />
              </div>
              <div className="formInput">
                <label>Marque</label>
                <input type="text" placeholder='BMW' id='Marque' value={Marque} onChange={(e) => setMarque(e.target.value)} />
              </div>
              <div className="formInput">
                <label>Nombre Cv</label>
                <input type="text" placeholder='12 ' id='Nombre_Cv' value={Nombre_Cv} onChange={(e) => setNombre_Cv(e.target.value)} />
              </div>
              <div className="formInput">
                <label>Serie</label>
                <input type="text" placeholder='classe a' id='Serie' value={Serie} onChange={(e) => setSerie(e.target.value)} />
              </div>
              <div className="formInput">
                <label className='annee'>Annee</label>
                <input type="text" placeholder='2017' id='Annee' value={Annee} onChange={(e) => setAnnee(e.target.value)} className="annee" />
              </div>
                <button>Send</button>
            </form>
          </div>
